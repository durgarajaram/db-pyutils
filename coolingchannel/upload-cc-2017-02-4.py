...
data = [\
  {'polarity': 1, 'coils': \
   [{'vlim': 5.0, 'name': 'SSU-T2', 'iset': 0.0, 'calibration': 0.0451, 'ilim': 1.0, 'stability': 0.0, 'rate': 0.0}, \
    ...
    {'vlim': 7.0, 'name': 'SSU-M2', 'iset': 226.61, 'calibration': 0.0201, 'ilim': 230.0, 'stability': 95.0, 'rate': 0.025}, \
    {'vlim': 7.0, 'name': 'SSU-M1', 'iset': 220.81, 'calibration': 0.0302, 'ilim': 225.0, 'stability': 95.0, 'rate': 0.0123} \
   ], \
   'name': 'SSU', 'mode': 'solenoid'\
  },\
  {'polarity': -1, 'coils': \
   [{'vlim': 11.0, 'name': 'FCU-C', 'iset': 106.11, 'calibration': 0.0268, 'ilim': 110.0, 'stability': 95.0, 'rate': 0.005}],\
    'name': 'FCU', 'mode': 'flip'\
  },\
  {'polarity': -1, 'coils':\
