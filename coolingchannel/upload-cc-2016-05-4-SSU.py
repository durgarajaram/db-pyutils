...
_pre_server = CoolingChannelSuperMouse(_TEST_CDB)
print _master_server
############################################################################
_CC_TAG = '2016-05-4-SSU'
data = [\
  {'polarity': 1, 'coils': \
   [{'vlim': 5.0, 'name': 'SSU-T2', 'iset': 0.0, 'calibration': 0.0451, 'ilim': 1.0, 'stability': 0.0, 'rate': 0.0}, \
    {'vlim': 16.0, 'name': 'SSU-C', 'iset': 205.91 , 'calibration': 0.0147, 'ilim': 210.0, 'stability': 95.0, 'rate': 0.0246}, \
    {'vlim': 5.0, 'name': 'SSU-T1', 'iset': 0.0, 'calibration': 0.0407, 'ilim': 1.0, 'stability': 0.0, 'rate': 0.0}, \
    {'vlim': 7.0, 'name': 'SSU-M2', 'iset': 172.37, 'calibration': 0.0201, 'ilim': 180.0, 'stability': 95.0, 'rate': 0.025}, \
    {'vlim': 7.0, 'name': 'SSU-M1', 'iset': 101.18, 'calibration': 0.0302, 'ilim': 110.0, 'stability': 95.0, 'rate': 0.0123} \
   ], \
  ...
  {'polarity': -1, 'coils':\
   [{'vlim': 5.0, 'name': 'SSD-T2', 'iset': 0.0, 'calibration': 0.0451, 'ilim': 1.0, 'stability': 0.0, 'rate': 0.0},\
    {'vlim': 16.0, 'name': 'SSD-C', 'iset': 0.0, 'calibration': 0.0147, 'ilim': 0.0, 'stability': 95.0, 'rate': 0.0246},\
...
#print _pre_server.set_coolingchannel_tag(_CC_TAG, data)
print _master_server.set_coolingchannel_tag(_CC_TAG, data)

print '++++++ Channel Tag', _CC_TAG
#print _pre_server.get_coolingchannel_for_tag(_CC_TAG)
print _master_server.get_coolingchannel_for_tag(_CC_TAG)
