...
data = [\
  {'polarity': 1, 'coils': \
   [{'vlim': 5.0, 'name': 'SSU-T2', 'iset': 0.0, 'calibration': 0.0451, 'ilim': 1.0, 'stability': 0.0, 'rate': 0.0}, \
    ...
    {'vlim': 7.0, 'name': 'SSU-M2', 'iset': 154.2, 'calibration': 0.0201, 'ilim': 230.0, 'stability': 95.0, 'rate': 0.025}, \
    {'vlim': 7.0, 'name': 'SSU-M1', 'iset': 209.54, 'calibration': 0.0302, 'ilim': 225.0, 'stability': 95.0, 'rate': 0.0123} \
   ], \
   'name': 'SSU', 'mode': 'solenoid'\
  },\
  {'polarity': 1, 'coils': \
   [{'vlim': 11.0, 'name': 'FCU-C', 'iset': 65.53, 'calibration': 0.0268, 'ilim': 110.0, 'stability': 95.0, 'rate': 0.005}],\
    'name': 'FCU', 'mode': 'solenoid'\
  },\
  {'polarity': 1, 'coils':\
   [{'vlim': 5.0, 'name': 'SSD-T2', 'iset': 0.0, 'calibration': 0.0451, 'ilim': 1.0, 'stability': 0.0, 'rate': 0.0},\
    {'vlim': 16.0, 'name': 'SSD-C', 'iset': 205.7, 'calibration': 0.0147, 'ilim': 210.0, 'stability': 95.0, 'rate': 0.0246},\
    {'vlim': 5.0, 'name': 'SSD-T1', 'iset': 0.0, 'calibration': 0.0407, 'ilim': 1.0, 'stability': 0.0, 'rate': 0.0},\
    {'vlim': 7.0, 'name': 'SSD-M2', 'iset': -190.86, 'calibration': 0.0201, 'ilim': 1.0, 'stability': 95.0, 'rate': 0.025},\
