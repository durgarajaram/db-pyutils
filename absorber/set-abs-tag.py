...
abs_data = [\
        {'name':'primary','material':'solid','shape':'empty','temperature':'0','pressure':'0','comment':'Empty solid absorber'},\
...
print 'Get'
print cc.get_absorber_for_tag(_ABS_TAG)
#print xml
